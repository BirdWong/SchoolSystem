...
public class MD5Util {
    ...
    public static boolean mattch(String pwd, String saved){
        if (saved!=null && "".equals(saved) && pwd != null && "".equals(pwd)) {
            if (string2MD5(pwd).equals(convertMD5(saved))) {
                return true;
            }
        }
        return false;
    ...
    public static void main(String args[]) {  
        ...
        String pwd = "123456";
        String saved = convertMD5(string2MD5(pwd));
        if (string2MD5(pwd).equals(convertMD5(saved))){
        ...
        String str="\u0011ED\u0015\u0010\u0017GM@M\u0016\u0015AM\u0015\u0016\u0016\u0011AB\u0011DAC\u0012FD\u0012LLG\u0011";
        str = convertMD5(str);
