...
public class ArticleInfomationController {
    ...
    public MessageResult add(HttpServletRequest req, @RequestBody ArticleComplex articleComplex){
        boolean isUser = CheckUserUtil.isUser(req, articleComplex.getArticle().getUid());
        if (isUser){
            return articleInfomationService.add(articleComplex);
        }else {
    ...
    public MessageResult deleteByAid(HttpServletRequest req, @PathVariable(value = "uid") int uid, @PathVariable(value = "aid")int aid){
        if (CheckUserUtil.isUser(req, uid)){
            return articleInfomationService.deleteByAid(aid, uid);
        }else {
    ...
    public MessageResult adminDeleteByAid(@PathVariable(value = "aid") int aid){
        return articleInfomationService.adminDeleteByAid(aid);
    }
