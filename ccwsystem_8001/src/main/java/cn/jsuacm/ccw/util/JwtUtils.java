...
public class JwtUtils {
   ...
   */
     ...
     * @return token String
     */
    public static String createJwtToken(int uid, String accountNumber,List<String> authorizations, String issuer, String subject, long ttlMillis) {
        ...
        claims.put("account", accountNumber);
